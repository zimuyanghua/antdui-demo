    ...
    public partial class ChatListDemo : UserControl
    {
        ...
        private void ChatListDemo_Load(object sender, EventArgs e)
        {
            Task.Run(() =>
            {
                ...
                chatList.AddToBottom(new AntdUI.Chat.TextChatItem("城区这车油耗就是高，没啥说的，suv本来就不省油", Properties.Resources.head, "AduSkin"));
                Thread.Sleep(700);
                ...
                chatList.AddToBottom(new AntdUI.Chat.TextChatItem("我看一般都前端做的，winform还没见过", Properties.Resources.head, "阿枫"));
                Thread.Sleep(700);
